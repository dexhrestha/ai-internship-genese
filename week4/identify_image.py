...
parser = argparse.ArgumentParser(description='Identify images')
parser.add_argument('image_url',metavar='u',type=str,help="URL of photo to be identified")
...
if __name__ == "__main__":
    ...
    print(generate_content(args.image_url))